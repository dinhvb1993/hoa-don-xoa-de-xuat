...
@Service
public class FilesStorageCustomServiceImpl implements FilesStorageCustomService {

  private Path root = Paths.get("uploads/test");
...
//      throw new RuntimeException("Error: " + e.getMessage());
  ...
  public void setPath(String path){
    ...
    StringBuilder targetPath = new StringBuilder("uploads");

    for (String pathItem: path.split("-")){
      targetPath.append("/").append(pathItem);
    }

    this.root = Paths.get(targetPath.toString());
  }
